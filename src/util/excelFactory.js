...
const ExcelSheet = function () {
    var self = {};

    self.build = function () {
        try {

            createRadar('MyRadar', data);
...
function plotFooter(content) {
    content
        ...
        + 'You also agree to our <a href="https://www.thoughtworks.com/privacy-policy">privacy policy</a>, which describes how we will gather, use and protect any personal data contained in your public Excel Sheet. '
...
function plotForm(content) {
    content.append('div')
        ...
        .append('p')
        .html('<strong>Enter the URL of your <a href="https://support.Excel.com/docs/answer/37579" target="_blank">published</a> Excel Sheet below…</strong>');
    ...
    form.append('input')
        .attr('type', 'text')
        .attr('name', 'sheetId')
        .attr('placeholder', 'e.g. https://docs.Excel.com/spreadsheets/d/1--_uLSNf/pubhtml');
